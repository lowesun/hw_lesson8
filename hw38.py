...
"Эта функция показывает информацию в файле"
...
"Эта функция записывает информацию в файл"
...
"Эта функиця изменяет информацию из файла"
...
"Эта функиця удаляет информацию из файла"
...
def main():
    ...
    "Эта функция создает файл если его нет в папке"
